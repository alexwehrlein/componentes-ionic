...
const routes: Routes = [
    ...
    },
    {
        path: "action-sheet",
        loadChildren: () =>
            import("./pages/action-sheet/action-sheet.module").then((m) => m.ActionSheetPageModule),
    },
    {
        path: "avatar",
    ...
    },
    {
        path: "infinite",
        loadChildren: () =>
            import("./pages/infinite/infinite.module").then((m) => m.InfinitePageModule),
    },
    {
        path: "input",
  ...
  {
    path: 'segmen',
    loadChildren: () => import('./pages/segmen/segmen.module').then( m => m.SegmenPageModule)
  },
  {
    path: 'slides',
